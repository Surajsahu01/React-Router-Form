...
const Template = ({title,desc1,desc2,imgae,formtype, setisLoggedIn}) => {
  return (
    <div className=' flex justify-between w-11/12 max-w-[1160px] gap-x-12 gap-y-0 py-12 mx-auto'>

        <div className='w-11/12 max-w-[450px]'>
            <h1 className='text-richblack-5 font-semibold text-[27px] leading-[2.375rem]'>
                {title}</h1>

            <p className='text-[15px] leading-[1.625rem] mt-1'>
